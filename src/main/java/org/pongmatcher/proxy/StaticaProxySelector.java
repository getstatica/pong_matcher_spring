...
public class StaticaProxySelector extends ProxySelector {
    ...
    List<String> hostExceptions = new ArrayList<String>();
        ...
        public StaticaProxySelector(ProxySelector def) {
          // Save the previous default
          defsel = def;
          String proxyUrlEnv = Statica.getUri();
          if(proxyUrlEnv!=null){  
          try{
            ...
            System.out.println("Routing traffic through Statica Static host "+proxyHost);
            //Create list of IP/hostnames to include
            String qgMask = System.getenv("STATICA_MASK");
            if(qgMask!=null){
                System.out.println("Statica Static only routing for traffic to "+qgMask);
